            ...
            <aside class="invoice-checkout-panel">
                ...
                <div class="invoice-payment-option">
                    ...
                    <strong>
                        ...
                        <% } else { %>
                            <%= paymentList.isEmpty() ? "Chưa thanh toán" : text(paymentList.get(0).getPhuongThuc()) %>
                        <% } %>
                    </strong>
                </div>
                ...
                <% if (hoaDon.getTrangThai() != null && hoaDon.getTrangThai() == 5) { %>
                <div style="background-color: #fbf9f4; border: 1px solid #e9e3d7; border-radius: 12px; padding: 16px; margin-top: 16px; display: flex; justify-content: space-between; align-items: center;">
                    <span style="color: #4b5563; font-weight: 600;">Trạng thái</span>
                    <strong style="color: #dc2626; font-size: 15px;">Đã hủy</strong>
                </div>
                <% } else if (hoaDon.getTrangThai() != null && hoaDon.getTrangThai() == 3) { %>
                <div style="background-color: #fbf9f4; border: 1px solid #e9e3d7; border-radius: 12px; padding: 16px; margin-top: 16px; display: flex; justify-content: space-between; align-items: center;">
                    <span style="color: #4b5563; font-weight: 600;">Trạng thái</span>
                    <strong style="color: #4b5563; font-size: 15px;">Đã thanh toán đủ</strong>
                </div>
                <% } %>
                
                <% if (hoaDon.getTrangThai() == null || (hoaDon.getTrangThai() != 5 && hoaDon.getTrangThai() != 3)) { %>
                <form method="post" action="<%= request.getContextPath() %>/admin/hoa-don">
                    ...
                    <button class="invoice-pay-btn" type="submit">
                        <i class="fas fa-money-bill-wave"></i>
                        Thanh toán tiền mặt
                    </button>
                </form>
                <button class="invoice-pay-btn invoice-pay-btn--qr" type="button" data-open-modal="qrPaymentModal">
