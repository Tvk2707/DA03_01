<%
    request.setAttribute("pageTitle", "Kiểu Dáng");
...
<div class="dashboard-container">
    ...
    <div class="category-section">
        <div class="category-header">
            <h2 class="category-title">Kiểu Dáng</h2>
        ...
        <div class="search-card">
            <form action="${pageContext.request.contextPath}/KieuDang" method="get" class="search-form">
                <div class="search-input-wrapper">
                    <i class="fas fa-search search-icon"></i>
                    <input type="text" name="keyword" value="${keyword}" placeholder="Tìm kiếm kiểu dáng...">
                </div>
                <button type="submit" class="search-btn">
                    <i class="fas fa-search"></i> Tìm kiếm
                </button>
                <c:if test="${not empty keyword}">
                    <a href="${pageContext.request.contextPath}/KieuDang" class="clear-btn">
        ...
        <table class="category-table">
            ...
            <c:forEach var="temp" items="${items}">
                <tr>
                    ...
                    <td><span class="category-name">${temp.tenKieuDang}</span></td>
                    ...
                    <td>
                        <div class="action-buttons">
                            <button type="button" class="action-btn edit-btn" title="Sửa"
                                    onclick="openEditModal('${temp.id}', '${temp.tenKieuDang}', '${temp.trangThai}')">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form action="${pageContext.request.contextPath}/KieuDang/delete?id=${temp.id}" method="post" style="display:inline;">
        ...
        <form action="${pageContext.request.contextPath}/KieuDang/insert" method="post">
            <div class="modal-body">
                <div class="form-group">
                    <label for="tenKieuDang">Tên Kiểu Dáng</label>
                    <input type="text" id="tenKieuDang" name="tenKieuDang" placeholder="Nhập tên kiểu dáng" required>
                </div>
