...
<div class="dashboard-container">
    ...
    <div class="category-section">
        ...
        <div class="search-card">
            <form action="${pageContext.request.contextPath}/DanhMuc" method="get" class="search-form">
                ...
                <c:if test="${not empty keyword}">
                    <a href="${pageContext.request.contextPath}/DanhMuc" class="clear-btn">
        ...
        <table class="category-table">
            ...
            <c:forEach var="temp" items="${items}">
                <tr>
                    ...
                    <td><span class="category-code">${temp.maDanhMuc}</span></td>
                    <td><span class="category-name">${temp.tenDanhMuc}</span></td>
                    ...
                    <td>
                        <div class="action-buttons">
                            <button type="button" class="action-btn edit-btn" title="Sửa"
                                    onclick="openEditModal('${temp.id}', '${temp.maDanhMuc}', '${temp.tenDanhMuc}', '${temp.trangThai}')">
                                <i class="fas fa-edit"></i>
                            </button>
                            <form action="${pageContext.request.contextPath}/DanhMuc/delete?id=${temp.id}" method="post" style="display:inline;">
...
<div id="addCategoryModal" class="modal-overlay">
    <div class="modal-content">
        ...
        <form action="${pageContext.request.contextPath}/DanhMuc/insert" method="post">
...
<div id="editCategoryModal" class="modal-overlay">
    <div class="modal-content">
        ...
        <form action="${pageContext.request.contextPath}/DanhMuc/update" method="post">
            <div class="modal-body">
                <input type="hidden" id="editId" name="id">

                <div class="form-group">
                    <label for="editMaDanhMuc">Mã danh mục</label>
                    <input type="text" id="editMaDanhMuc" name="maDanhMuc" value="${danhMuc.maDanhMuc}" readonly style="background-color: #f5f5f5; cursor: not-allowed;">
                </div>
